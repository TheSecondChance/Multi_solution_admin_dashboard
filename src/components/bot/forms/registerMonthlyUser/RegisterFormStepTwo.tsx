...
const RegisterFormStepTwo: React.FC<Props> = ({
  stepOneFormData,
  stepTwoFormData,
  setStepTwoFormData,
}) => {
  ...
  useEffect(() => {
    ...
    if (isRegisteringTraineeSuccess) {
      toast.success(t("You've Successfully. Registered"))
      navigate("/bot/success")
    }

    dispatch(reset())
  }, [message, dispatch, t, isError, navigate, isRegisteringTraineeSuccess])
