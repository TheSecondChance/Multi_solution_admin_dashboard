...
import FixedPaymentListTable from "@/components/tables/finance/FixedPaymentListTable"
import { useAppDispatch, useAppSelector } from "@/app/hooks"
import { createBankAccount, reset } from "@/features/finance/financeSlice"
...
export default function FixedFinance() {
  ...
  useEffect(() => {
    ...
    dispatch(reset())
  }, [form, dispatch, isAddingBankAccountSuccess])
  ...
  return (
    <Layout>
      ...
      <FixedPaymentListTable title='Trainee Payment' />
    </Layout>
  )
}
